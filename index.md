...
Como parte de esta estrategia, se creó una promoción de prevención destinada a los primeros clientes. El objetivo era comunicar beneficios exclusivos y generar interés antes de la apertura oficial de la tienda online.
...
Al ingresar a la tienda online, algunos clientes observaron que los precios publicados no coincidían con los valores anunciados en la campaña de prevención.
...
Revisión inmediata de todos los precios publicados. Verificación de la configuración de productos dentro de la tienda online. Corrección de los valores que presentaban discrepancias. Actualización y validación de las piezas promocionales. Confirmación final de consistencia entre ambos canales antes de reanudar la campaña.
...
Lista de verificación de validación previa a campañas

Antes de publicar cualquier promoción se verifica:

Precio promocional. Precio en tienda online. Disponibilidad de stock. Enlaces de navegación. Fechas de vigencia. Condiciones de la promoción. Validación cruzada

Se incorporará una revisión conjunta entre las personas responsables de marketing y de comercio electrónico antes de aprobar cualquier publicación.
...
El uso de estas herramientas está permitido:

Mantener un historial de cambios. Decisiones importantes del registrador. Aprendizajes documentales. Facilitar futuras revisiones.

Algunos ejemplos de commits realizados durante el proceso fueron:

hazaña: crear documentación inicial del lanzamiento

docs: agregar análisis post-mortem del incidente

corrección: corrección documental de discrepancia de precios
...
También aprendimos que la documentación no debe ser considerada una tarea secundaria. Cuando los procedimientos están documentados y son accesibles para todos los participantes, resulta mucho más sencillo detectar inconsistencias antes de que lleguen al público.
...
El objetivo no fue identificar culpables, sino comprender qué aspectos del proceso podrían optimizarse.
